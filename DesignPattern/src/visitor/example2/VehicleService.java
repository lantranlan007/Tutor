...
public class VehicleService {
	// returns the total service charge of all the vehicles that are gone under full
	// service
	...
	public static void main(String[] args) {
		Vehicle[] vehicles = new Vehicle[] { new Car("Black", 2010), new Van(5000, 6), new Motorbike(100, "TVS") };
